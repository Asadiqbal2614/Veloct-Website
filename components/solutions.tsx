...
export default function Solutions() {
  return (
    <section id="solutions" className="relative py-16 lg:py-20 bg-white dark:bg-[#00164A] transition-colors duration-300">
          ...
          {SOLUTIONS.map((solution, idx) => {
            ...
            return (
              <AnimateOnScroll key={solution.title} delay={idx * 50}>
                <div className="bg-slate-50 border border-slate-200/80 shadow-sm dark:bg-white/5 dark:border-white/10 dark:shadow-none rounded-xl p-5 sm:p-6 flex items-center gap-4 group cursor-pointer card-hover-lift">
                  ...
                  <h3 className="text-sm sm:text-base font-semibold text-slate-900 dark:text-white group-hover:text-[#FE7004] transition-colors duration-300">
                    {solution.title}
                  </h3>
                </div>
              </AnimateOnScroll>
