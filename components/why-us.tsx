...
export default function WhyUs() {
  return (
    <section id="why-us" className="relative py-16 lg:py-20 bg-white dark:bg-[#00164A] transition-colors duration-300">
          ...
          {REASONS.map((reason, idx) => {
            ...
            return (
              <AnimateOnScroll key={reason.title} delay={idx * 80}>
                <div className="bg-slate-50 border border-slate-200/80 shadow-sm dark:bg-white/5 dark:border-white/10 dark:shadow-none rounded-xl p-6 lg:p-8 card-hover-lift h-full">
